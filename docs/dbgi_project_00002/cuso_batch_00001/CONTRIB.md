...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/dbgi-metabolomics/docs/dbgi_project_00002/cuso_batch_00001/results
```
...
paths:
  ...
  input_folder: /Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/dbgi-metabolomics/docs/dbgi_project_00002/cuso_batch_00001/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  ...
  output_folder: /Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/dbgi-metabolomics/docs/dbgi_project_00002/cuso_batch_00001/results/met_annot_enhancer # the path for your output to be stored in
...
paths:
  ...
  output: '/Users/pma/Dropbox/git_repos/mapp-metabolomics-unit/dbgi-metabolomics/docs/dbgi_project_00002/cuso_batch_00001/results/stats' # Not mandatory, default is in the stats subdirectory
...
dataset_experiment : 
  ...
  description: "Untargeted metabolomics of UniFr botanical samples CUSO - positive mode"
...
```bash
taxonomical-utils resolve --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata_resolved.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata_upper_taxa_lineage.csv
```

3. merge the taxonomy with the results

```bash
taxonomical-utils merge --input-file docs/dbgi_project_00002/cuso_batch_00001/metadata/original/cuso_batch_00001_metadata.csv --resolved-taxa-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata_resolved.csv --upper-taxa-lineage-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata_upper_taxa_lineage.csv --output-file docs/dbgi_project_00002/cuso_batch_00001/metadata/treated/cuso_batch_00001_metadata.tsv --org-column-header source_taxon --delimiter ','
```
